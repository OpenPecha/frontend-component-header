...
var Header = function Header(_ref) {
  ...
  useEffect(function () {
    var fetchProfileImage = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var baseUrl, apiUrl, response, _data$profile_image, _data$profile_image2, data, imageUrl, hasImage;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              if (authenticatedUser !== null && authenticatedUser !== void 0 && authenticatedUser.username) {
                _context.next = 6;
                break;
              }
              setAvatarState({
            ...
            case 6:
              _context.prev = 6;
              baseUrl = config.LMS_BASE_URL || '';
              apiUrl = "".concat(baseUrl, "/api/user/v1/accounts/").concat(authenticatedUser.username);
              _context.next = 11;
              return fetch(apiUrl, {
                credentials: 'include',
                headers: {
            ...
            case 15:
              data = _context.sent;
              imageUrl = (_data$profile_image = data.profile_image) === null || _data$profile_image === void 0 ? void 0 : _data$profile_image.image_url_medium;
              hasImage = (_data$profile_image2 = data.profile_image) === null || _data$profile_image2 === void 0 ? void 0 : _data$profile_image2.has_image; // Use the fetched image if it exists and is not a default one.
      ...
      return function fetchProfileImage() {
